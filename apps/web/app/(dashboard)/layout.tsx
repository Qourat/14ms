          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                ...
                <a href="/dashboard/imports" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                  Imports
                </a>
                <a href="/dashboard/posts" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                  Posts
                </a>
